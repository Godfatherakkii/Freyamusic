...
API_ID = int(getenv("API_ID", "7765926"))
API_HASH = getenv("API_HASH", "8e226ebfa42872d2fbc4bd8170c9c872")
...
OWNER_ID = int(getenv("OWNER_ID", "936481432"))
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Godfatherakkii/freyamusic",
)
...
AUTO_LEAVE_ASSISTANT_TIME = int(
    getenv("ASSISTANT_LEAVE_TIME", "24000")
...
SONG_DOWNLOAD_DURATION = int(getenv("SONG_DOWNLOAD_DURATION", 9000))
SONG_DOWNLOAD_DURATION_LIMIT = int(getenv("SONG_DOWNLOAD_DURATION_LIMIT", 9000))


# Telegram audio and video file size limit (in bytes)
TG_AUDIO_FILESIZE_LIMIT = int(getenv("TG_AUDIO_FILESIZE_LIMIT", 1004857600))
TG_VIDEO_FILESIZE_LIMIT = int(getenv("TG_VIDEO_FILESIZE_LIMIT", 10073741824))
